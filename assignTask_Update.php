...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `task` SET `StaffID`='$StaffID',`Task`='$Task',`AssignedDates`='$AssignedDate',`TaskStatus`='$TaskStatus'  WHERE `TaskID`='$TaskID'";
...
if (isset($_GET['TaskID '])) {
    ...
    <html>
    <head>
        <title>Assign Task Update Form</title>
    ...
    <div class="container">
      ...
      <div class="form-group">
        <label for="AssignedDate">AssignedDate:</label>
