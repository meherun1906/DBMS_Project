...
$sql = " SELECT AssessmentID, t_ID, AssessmentDate, HealthStatus, Treatment, Vaccination, Illness_Injury, CarePlanning FROM `healthassessment`";
...
<table style="border: 0px solid #ddd;">
    ...
    <td style="border: 0px solid #ddd;"><a href="healthAssessement_Create.php" class="button">Add</a></td>
</table>
