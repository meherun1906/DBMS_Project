...
include "./db.php";
$sql = " SELECT assessmentID, t_ID, assessmentDate, healthStatus, Ttreatment, vaccination, illness_Injury, carePlanning  FROM h_assessment";
...
<table style="border: 0px solid #ddd;">
    ...
    <td style="border: 0px solid #ddd;"><a href="healthAssessment_Create.php" class="button">Add</a></td>
</table>
...
<table id="myTable">    
  ...
  <tr>                                        
    ...
    <td><?php echo $row['Ttreatment']; ?></td>
    <td><?php echo $row['vaccination']; ?></td>
    <td><?php echo $row['illness_Injury']; ?></td>
    <td><?php echo $row['carePlanning']; ?></td>
    <td>
      <a href="healthAssessment_Update.php?assessmentID=<?php echo $row['assessmentID']; ?>" class="button">Edit</a>
      <a href="healthAssessment_Delete.php?assessmentID=<?php echo $row['assessmentID']; ?>" class="button" style="background-color: #cf5555;">Delete</a>
    </td>
  </tr>
  <?php
      }
